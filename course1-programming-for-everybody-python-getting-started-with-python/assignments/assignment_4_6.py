...
# normal rate for hours up to 40 and time-and-a-half for the hourly rate
# for all hours worked above 40 hours. Put the logic to do the computation of pay in
